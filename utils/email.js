...
const sendEnquiryEmailHelper = (email, phoneNumber, productName, category, name, writtenMessage, senderEmail) => {
    const content = `
            <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                <div style="margin:50px auto;width:70%;padding:20px 0">
                    <div style="border-bottom:1px solid #eee">
                        <a href="" style="font-size:1.4em;color: #00466A;text-decoration:none;font-weight:600">Laxnar</a>
                    </div>
                    <p style="font-size:1.1em">Hi,</p>
                    <p>We have got a new Product Enquiry on Laxnar, details are Mentioned Below</p>
                    <h4 style="background: #00466A;margin: 0 auto;width: 90%;padding: 0 10px;color: #fff;border-radius: 4px;">
                    ...
                    <p style="font-size:0.9em;">Regards,<br />Laxnar</p>
...
const sendMail = async (content, toEmail, subject) => {
    try {
